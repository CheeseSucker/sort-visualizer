...
/*************************************************************************
 *  Changes from Draw by Sedgewick and Wayne:
 *    - Remove window borders
 *    - Close program when one window is closed
 *    - Removed code for keyboard and mouse events
 *
...
public final class Drawer {
    ...
    *************************************************************************/
    ...
    private Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = Drawer.class.getResource(filename);
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        draw1.circle(.8, .2, .2);
        draw1.setPenColor(Drawer.MAGENTA);
        ...
        // text
        draw2.setPenColor(Drawer.BLACK);
        draw2.text(0.2, 0.5, "bdfdfdfdlack text");
        draw2.setPenColor(Drawer.WHITE);
